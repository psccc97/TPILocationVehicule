...
if (filter_has_var(INPUT_POST, 'modifier')) {
    ...
    if($image['size']> 5000000){
        ...
        if (file_exists("img/" . $image['name'])) {
            ...
            $destinationImage = "img/".$idUniq.$image['name'];
    ...
    if ($dateFin < $dateDebut) {
        ...
        if (modifVehicule($idVehicule, $type, $description, $annee, $categorie, $nbrPlace, $volumeUtile, $motorisation, $image['name'], $idMarque, $idModele, $idKilometrage, $dateDebut, $dateFin, $longitude, $latitude)) {
